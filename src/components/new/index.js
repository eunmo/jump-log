      ...
      <div>
        <div style={gridStyleA}>
          {this.state.titles.map(title => (
            <div
              ...
              onClick={() => this.addEpisode(title)}
            >
              <div className="ellipsis">
                {this.state.episodes.includes(title) ? (
                  title.name
                ) : (
                  <b>{title.name}</b>
                )}
        ...
        <div style={dateInputGridStyle}>
          ...
          <input
            ...
            name="date"
            value={issue.date}
            onChange={event => this.type(event, issue)}
              ...
              return (
                <div style={gridStyleB} key={index}>
                  ...
                  <div
                    ...
                    onClick={() => this.removeEpisode(index)}
                  >
                    X
                  </div>
                  <div>
                    ...
                    <div>
                      <input
                        type="checkbox"
                        name="color"
                        defaultChecked={entry.color === 1}
                        onChange={event => this.check(event, entry)}
                      />{' '}
                      Color
                    </div>
                  </div>
                  ...
                  <div>
                    <div style={textInputGridStyle}>
                      ...
                      <input
                        ...
                        name="name"
                        value={entry.name}
                        onChange={event => this.type(event, entry)}
                        style={textInputStyle}
                      />
                    </div>
                    <div style={textInputGridStyle}>
                    ...
                    <div>
                      <input
                        type="checkbox"
                        name="yomikiri"
                        defaultChecked={entry.yomikiri === 1}
                        onChange={event => this.check(event, entry)}
                      />{' '}
                      読切
                      <span
