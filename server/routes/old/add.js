...
module.exports = function(router, db) {
	...
	var getTitle = async function(title) {
		...
		const insert = "INSERT INTO titles (name, author) VALUES (\'" + name + "\', \'" + title.author + "\')";
	...
	var insertEpisodes = async function(issue, json) {
		...
		var insert = "INSERT INTO episodes (issueId, titleId, rawOrder, trueOrder, note, type) VALUES " + values.join(',');
